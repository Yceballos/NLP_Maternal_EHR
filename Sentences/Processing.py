...
class PretrainDataset(Dataset):
    ...
    def __init__(self,pickle_path,tokenizer_path):
        ...
        labels[482][12]='I-Atributo' ##token: 500  
        labels[482][13]='I-Atributo' ##token: mg
        labels[482][14]='I-Atributo' ##token: cada
        labels[482][15]='I-Atributo' ##token: 12
        labels[482][16]='I-Atributo' ##token: horas
        labels[506][35]='B-Procedimiento' ##token: PA 
        labels[904][21]='B-Atributo' ##token: 78xmin 
        labels[904][110]='B-Atributo' ##token: controlada
        labels[905][24]='B-Sustancia' ##token: dextrometer
        labels[998][150]='B-Atributo' ##token: escasos
        labels[1005][88]='B-Atributo'  #token:fetido
        labels[1088][16]='B-Signo o síntoma' #token:actividad
        labels[1088][17]='I-Signo o síntoma' #token: uterina 
        labels[1117][95]='B-Sustancia'#token: hb  
        labels[1321][9]='B-Atributo'  #token: semana 
        labels[1321][10]='I-Atributo' #token: 6
        labels[1321][11]='I-Atributo' #token: +
        labels[1321][12]='I-Atributo' #token: 2
        labels[1321][13]='I-Atributo' #token: del
        labels[1332][4]='B-Signo o síntoma' #token:edema
        labels[1358][8]='B-Procedimiento' ##token: Hto 
        
        # labels[305][8]='B-Procedimiento' ##token: Hto 
        # labels[442][9]='B-Atributo'  #token: semana
        # labels[442][10]='I-Atributo' #token: 6
        # labels[442][11]='I-Atributo' #token: +
        # labels[442][12]='I-Atributo' #token: 2
        # labels[442][13]='I-Atributo' #token: del
        # labels[453][4]='B-Signo o síntoma' #token:edema
        # labels[483][88]='B-Atributo'  #token:fetido
        # labels[488][16]='B-Signo o síntoma' #token:actividad
        # labels[488][17]='I-Signo o síntoma' #token: uterina 
        # labels[507][35]='B-Procedimiento'  #token:PA
        # labels[618][12]='B-Atributo'  #token:500
        # labels[618][13]='I-Atributo'  #token:mg
        # labels[618][14]='I-Atributo'  #token:cada
        # labels[618][15]='I-Atributo'  #token:12
        # labels[618][16]='I-Atributo'  #token: horas
        # labels[872][21]= 'B-Atributo' #token: 78xmin 
        # labels[872][110]= 'B-Atributo' #token: controlada
        # labels[873][24]='B-Sustancia'#token: dextrometer
