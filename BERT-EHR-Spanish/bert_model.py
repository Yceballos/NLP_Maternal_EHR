# -*- coding: utf-8 -*-
"""
Created on Fri Jun  3 00:03:02 2022
...
from data_preprocessing import PretrainDataset
...
# args
bert_path = "C:/Users/User/Desktop/es-cli-bert/bsc-bio-es"# Directory containing BERT checkpoint
#vocab_file = "C:/Users/User/Desktop/es-cli-bert/bsc-bio-es" #json vocab file
pickle_path="C:/Users/User/Desktop/es-cli-bert/datahc_ner.pkl"
batch_size = 5 ###7max
patience = 2

##setup
device = torch.device("cuda" if torch.cuda.is_available() else "cpu") #is still in CPU!
n_gpu = torch.cuda.device_count()


# load data
dataset = PretrainDataset("C:/Users/User/Desktop/es-cli-bert/datahc_ner.pkl",
