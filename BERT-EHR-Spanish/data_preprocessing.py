# -*- coding: utf-8 -*-
"""
Created on Thu Jun  2 23:56:26 2022

@author: María Camila D. 
"""
...
class PretrainDataset(Dataset):
    ...
    def __init__(self,pickle_path,tokenizer_path):
        ...
        labels[20][235]='O'
        ##1163255.xmi
        labels[35][92]='B-Atributo'
        labels[35][93]='I-Atributo'
        labels[35][94]='I-Atributo'
        labels[35][95]='I-Atributo'
        labels[35][96]='I-Atributo'
        labels[35][510]='B-Signo o síntoma'
        ##38
        labels[38][88]='B-Atributo'
        #39
        labels[39][65]='B-Atributo'
        labels[39][66]="I-Atributo"
        #42
        labels[42][636]='B-Procedimiento'
        #51
        labels[51][112]='B-Atributo'
        labels[51][113]='I-Atributo'
        labels[51][114]='I-Atributo'
        labels[51][115]='I-Atributo'
        labels[51][116]='I-Atributo'

        #63
        labels[63][713]='B-Atributo'
        labels[63][802]='B-Atributo'
        labels[63][887]='B-Sustancia' #dextrometer
        ##67
        labels[67][255]='I-Atributo' ##hb
        ##78
        labels[78][150]='B-Atributo'
    ...
    def process_text(self,sentences,labels2,max_len=128):
        ...
        ####hacer for para cada 125 palabras de la nota
